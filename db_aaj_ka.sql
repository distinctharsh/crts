...
-- Dumping data for table tms-laravel.activity_log: ~12 rows (approximately)
...
-- Dumping data for table tms-laravel.complaint_actions: ~1 rows (approximately)
...
-- Dumping data for table tms-laravel.complaints: ~1 rows (approximately)
...
INSERT INTO `request_types` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
	(1, 'Change Record', 'change_record', '2026-07-03 06:09:31', '2026-07-03 06:09:31'),
	(2, 'New Entry', 'new_entry', '2026-07-03 06:09:31', '2026-07-03 06:09:31');
